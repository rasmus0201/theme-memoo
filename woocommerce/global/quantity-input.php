...
if ( $max_value && $min_value === $max_value ) {
	?>
	<div class="quantity hidden" data-title="<?php echo memoo_wc_qty_title(); ?>">
		<input type="hidden" class="qty" name="<?php echo esc_attr( $input_name ); ?>" value="<?php echo esc_attr( $min_value ); ?>" />
	</div>
	<?php
} else {
	?>
	<div class="quantity" data-title="<?php echo memoo_wc_qty_title(); ?>">
	...
	<div class="buttons-qty">
		<a type="button" class="btn qty-increment" data-field="qty">
			<i class="fal fa-plus"></i>
		</a>
		<a type="button" class="btn qty-decrement" data-field="qty">
